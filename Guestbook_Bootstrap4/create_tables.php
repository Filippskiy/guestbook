...
try {
    ...
    if (!$conn->query("CREATE TABLE IF NOT EXISTS GBookTable (id INT NOT NULL AUTO_INCREMENT, caption VARCHAR (100), date DATETIME, message TEXT, user_id INT, PRIMARY KEY (id))")) {
